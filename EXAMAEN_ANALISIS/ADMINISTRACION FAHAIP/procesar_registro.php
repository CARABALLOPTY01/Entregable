...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $id_rol = 2; // Asignar el rol de 'Usuario' por defecto. Cambia este valor según necesites.

    // Inserción del nuevo usuario con un rol predeterminado
    $sql = "INSERT INTO Usuario (nombre, Correo, Contraseña, ID_Rol) VALUES ('$nombre', '$email', '$password', '$id_rol')";
