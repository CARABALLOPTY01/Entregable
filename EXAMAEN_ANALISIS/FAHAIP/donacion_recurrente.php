...
<head>
    ...
    <title>Donación Recurrente - Fundación FAHAIP PANAMÁ</title>
...
<body>
    <div class="container">
        <h2 class="text-center">Formulario de Donación Recurrente</h2>
        <form method="POST" action="donaciones.php">
            ...
            <input type="hidden" name="tipo_donacion" value="Recurrente">
